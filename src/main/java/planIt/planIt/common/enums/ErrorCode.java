...
public enum ErrorCode {
    ...
    NOTFOUND_ID(HttpStatus.NOT_FOUND, "입력하신 정보와 일치하는 ID가 없습니다."),
    NOTFOUND_PW(HttpStatus.NOT_FOUND, "입력하신 정보와 일치하는 비밀번호가 없습니다."),
    MISSMATCH_LOGIN(HttpStatus.BAD_REQUEST, "ID 혹은 PW 가 일치하지 않습니다."),
    NOTFOUND_USER(HttpStatus.NOT_FOUND, "존재하지 않는 사용자 입니다."),
    DUPLICATE_ROLE(HttpStatus.BAD_REQUEST, "현재 ROLE과 동일합니다."),
    NOTFOUND_PLAN(HttpStatus.NOT_FOUND, "존재하지 않는 Plan 입니다.");
